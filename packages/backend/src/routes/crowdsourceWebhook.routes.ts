 ...
 *
 * The receiver itself is `@crowdsource.you/core/outbox`'s: signature verification,
 ...
 *
 * `@crowdsource.you/core/express` looks for a raw Buffer and refuses a parsed body,
