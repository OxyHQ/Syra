 ...
 * through `@crowdsource.you/core/outbox/postgres`'s `moderationReportColumnOptions`,
 ...
 *
 * Syra's SECOND status axis, and the one `@crowdsource.you/core/outbox` knows nothing
