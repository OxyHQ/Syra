...
-- Additive only: nullable audience timestamp and new, initially empty collaboration tables.
...
--> statement-breakpoint
ALTER TABLE "catalog_entities" ADD COLUMN "stats_monthly_listeners_computed_at" timestamp with time zone;--> statement-breakpoint
